...
class TestCatalog(unittest.TestCase):
        ...
        return self.c.post("/api/products", json={
            ...
            "variants": [
                ...
                {"attributes": {"規格": "霧面"}, "price": 690,
                 "barcodes": [{"barcode": "TL100000002", "source": "store"}]},
            ]}).json()
    ...
    def test_catalog_grouping(self):
        ...
        self.assertEqual(v0["barcodes"][0]["barcode"], "TL100000001")
    ...
    def test_scan_active_flag(self):
        r = self._create()
        vid0 = r["variant_ids"][0]
        self.assertTrue(self.c.get("/api/barcode/TL100000001").json()["active"])
        self.c.put(f"/api/variants/{vid0}", json={"active": 0})
        resp = self.c.get("/api/barcode/TL100000001")
    ...
    def test_delete_clean_variant(self):
        ...
        # 條碼一併消失
        self.assertEqual(self.c.get("/api/barcode/TL100000002").status_code, 404)
        # catalog 只剩 1 變體
    ...
    def test_delete_clean_product(self):
        ...
        self.assertEqual(self.c.get("/api/barcode/TL100000001").status_code, 404)

    # 7. DELETE /api/barcodes/{code}
    def test_delete_barcode(self):
        r = self._create()
        resp = self.c.delete("/api/barcodes/TL100000001")
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(self.c.get("/api/barcode/TL100000001").status_code, 404)
    ...
    def test_add_variant(self):
        ...
        self.assertTrue(resp["barcodes"][0].startswith("SP"))
