const API = {
  ...
  batchCreateVariants: (product_id, drafts) => API.invoke("variants.batch_create", {product_id, drafts}), batchPrecheckVariants: (product_id, drafts) => API.invoke("variants.batch_precheck", {product_id, drafts}), fieldUsage: (category_id, field_id, scope) => API.invoke("variants.field_usage", Object.assign({category_id, field_id}, scope || {})),
